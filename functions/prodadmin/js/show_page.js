function show_page() {
    auth('prodadmin@uco.edu',show_page_secured, '/login')
}
...
async function show_page_secured() {
    ...
    glPageContent.innerHTML = `
        ...
        <a href ="/show" class ="btn btn-outline-primary">Add A Product </a><br>
...
async function editProduct(index){
    ...
    Current Image: <br>
    <img class="card-img img-fluid" src="${p.image_url}"> <br>
    <div class = "form-group">
...
async function deleteProduct(index){
    try{
        const p = products[index]
        //delete 1 firestore doc, then storage img
